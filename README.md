...
For development purposes run the react dev environment with "npm start". Create a release bundle to be added to Go binary with "npx webpack --mode production"